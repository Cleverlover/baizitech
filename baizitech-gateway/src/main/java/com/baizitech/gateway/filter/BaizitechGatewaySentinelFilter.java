...
import com.baizitech.gateway.fallback.BaizitechGatewayBlockFallbackProvider;
...
@Slf4j
@Configuration
public class BaizitechGatewaySentinelFilter {
    @Bean
    ...
    @PostConstruct
    public void doInit() {
        ZuulBlockFallbackManager.registerProvider(new BaizitechGatewayBlockFallbackProvider());
        initGatewayRules();
    }
